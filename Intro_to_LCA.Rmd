---
title: "Introduction to Latent Class Analysis (LCA) with MplusAutomation"
subtitle: "*Enumeration, Summarizing Results, Explopring Response Patterns*"
author: "MM4DEBER Training Team"
...
- All values greater than zero were recorded as `1` indicating that the school has a staff present on campus at least part time.
Schools with no staff of the designated type are indicated by `0` for the dichotomous variable.
